...
import imageLink from '../../client/assets/image/repair2.png';
    ...
    onImageChange = (event) => {
        ...
        uploadImageAction(event.target.files[0]).then(response => {
            if (response.message === 'File uploaded!') {
                ...
                this.setState({ request: { ...request, imageData: require('../../client/assets/image/request.jpg'), image: 'client/assets/image/request.jpg' } });
              }
